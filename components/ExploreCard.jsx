...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-[1.82rem] sm:p-[1.50rem] rounded-[24px] lg:rounded-b-[24px] lg:rounded-t-none flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        <div
